...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// </summary>
        /// <param name="payPeriodId">The pay period ID which determines the organization and cutoff dates of the report.
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="organizationId">The ID of the organization that the report will be based.</param>
