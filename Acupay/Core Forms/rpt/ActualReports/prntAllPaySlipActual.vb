...
Public Class prntAllPaySlipActual
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "prntAllPaySlipActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GoldWingsPayrollSys.prntAllPaySlipActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprntAllPaySlipActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prntAllPaySlipActual = New prntAllPaySlipActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
