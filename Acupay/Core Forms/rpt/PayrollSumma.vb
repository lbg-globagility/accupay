...
Public Class PayrollSumma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GoldWingsPayrollSys.PayrollSumma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollSumma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollSumma = New PayrollSumma()
        rpt.Site = Me.Site
        Return rpt
    End Function
