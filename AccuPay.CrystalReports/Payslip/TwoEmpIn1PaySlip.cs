...
namespace AccuPay.CrystalReports.Payslip {
    ...
    public class TwoEmpIn1PaySlip : ReportClass {
        
        public TwoEmpIn1PaySlip() {
        }
        ...
        public override string FullResourceName {
            get {
                return "AccuPay.CrystalReports.Payslip.TwoEmpIn1PaySlip.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTwoEmpIn1PaySlip : Component, ICachedReport {
        
        public CachedTwoEmpIn1PaySlip() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            TwoEmpIn1PaySlip rpt = new TwoEmpIn1PaySlip();
            rpt.Site = this.Site;
            return rpt;
        }
