    ...
    Public Class OfficialBusinessRepository
        ...
        Private Async Function SaveAsyncFunction(officialBusiness As OfficialBusiness, context As PayrollContext) As Task
            ...
            If context.OfficialBusinesses.
                ...
                Where(Function(l) (l.StartDate.HasValue AndAlso officialBusiness.StartDate.HasValue AndAlso l.StartDate.Value = officialBusiness.StartDate.Value) OrElse
                                    (l.EndDate.HasValue AndAlso officialBusiness.EndDate.HasValue AndAlso l.EndDate.Value = officialBusiness.EndDate.Value)).
                Any() Then

                Throw New ArgumentException($"Employee already has an official business for {officialBusiness.StartDate.Value.ToShortDateString()}")
            End If
