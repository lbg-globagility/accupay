...
Public Class DayCalculator
    ...
    Private ReadOnly _organization As Entities.Organization
    ...
    Public Sub New(organization As Entities.Organization, settings As ListOfValueCollection, employee As Entities.Employee)
        _settings = settings
