...
Public Class LoanReportByTypePerPage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.LoanReportByTypePerPage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLoanReportByTypePerPage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LoanReportByTypePerPage = New LoanReportByTypePerPage()
        rpt.Site = Me.Site
        Return rpt
    End Function
