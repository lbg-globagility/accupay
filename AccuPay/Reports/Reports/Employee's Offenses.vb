...
Public Class Employees_Offenses
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Employee's Offenses.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.Employee's Offenses.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployees_Offenses
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Employees_Offenses = New Employees_Offenses()
        rpt.Site = Me.Site
        Return rpt
    End Function
