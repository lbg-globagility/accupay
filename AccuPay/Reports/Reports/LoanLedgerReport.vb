...
Public Class LoanLedgerReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.LoanLedgerReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLoanLedgerReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LoanLedgerReport = New LoanLedgerReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
