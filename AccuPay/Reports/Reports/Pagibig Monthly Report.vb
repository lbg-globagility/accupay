...
Public Class Pagibig_Monthly_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.Pagibig Monthly Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPagibig_Monthly_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Pagibig_Monthly_Report = New Pagibig_Monthly_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
