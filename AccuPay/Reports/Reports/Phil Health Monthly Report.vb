...
Public Class Phil_Health_Monthly_Report
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.Phil Health Monthly Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPhil_Health_Monthly_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Phil_Health_Monthly_Report = New Phil_Health_Monthly_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
