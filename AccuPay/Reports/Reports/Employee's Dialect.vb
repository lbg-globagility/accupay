...
Public Class Employees_Dialect
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.Employee's Dialect.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployees_Dialect
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Employees_Dialect = New Employees_Dialect()
        rpt.Site = Me.Site
        Return rpt
    End Function
