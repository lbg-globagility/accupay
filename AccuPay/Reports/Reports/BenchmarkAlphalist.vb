...
Public Class BenchmarkAlphalist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.BenchmarkAlphalist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBenchmarkAlphalist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BenchmarkAlphalist = New BenchmarkAlphalist()
        rpt.Site = Me.Site
        Return rpt
    End Function
