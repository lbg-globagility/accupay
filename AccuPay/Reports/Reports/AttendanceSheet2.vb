...
Public Class AttendanceSheet2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.AttendanceSheet2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAttendanceSheet2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AttendanceSheet2 = New AttendanceSheet2()
        rpt.Site = Me.Site
        Return rpt
    End Function
