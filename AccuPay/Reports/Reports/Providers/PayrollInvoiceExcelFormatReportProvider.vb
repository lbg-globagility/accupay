...
Public Class PayrollInvoiceExcelFormatReportProvider
    Implements IReportProvider

    Public Property Name As String = "Payroll Invoice" Implements IReportProvider.Name
    Public Property IsHidden As Boolean = False Implements IReportProvider.IsHidden

    Private ReadOnly _payrollInvoiceExcelFormatReportBuilder As IPayrollInvoiceExcelFormatReportBuilder
    Private ReadOnly _policy As IPolicyHelper

    Public Sub New()
        _payrollInvoiceExcelFormatReportBuilder = MainServiceProvider.GetRequiredService(Of IPayrollInvoiceExcelFormatReportBuilder)
    ...
    '    Try
    '        Dim outputDirectory = Await _payrollInvoiceExcelFormatReportBuilder.GenerateReportAsync(organizationId:=z_OrganizationID,
