...
Public Class PayrollSummaryExcelFormatAllownceSalaryReportProvider
    Implements IReportProvider

    Public Property Name As String = "Payroll Summary [Allowance Salary]" Implements IReportProvider.Name
    Public Property IsHidden As Boolean = False Implements IReportProvider.IsHidden

    Private _payrollSummaryReportBuilder As IPayrollSummaryReportBuilder

    Sub New()
        _payrollSummaryReportBuilder = MainServiceProvider.GetRequiredService(Of IPayrollSummaryReportBuilder)
    End Sub
    ...
    Public Async Sub Run() Implements IReportProvider.Run
        ...
        Try
            ...
            Await _payrollSummaryReportBuilder.CreateReport(
