...
Public Class HyundaiPayslip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.HyundaiPayslip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHyundaiPayslip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HyundaiPayslip = New HyundaiPayslip()
        rpt.Site = Me.Site
        Return rpt
    End Function
