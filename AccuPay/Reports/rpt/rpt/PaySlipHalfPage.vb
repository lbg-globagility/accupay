...
Public Class PaySlipHalfPage
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.PaySlipHalfPage.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPaySlipHalfPage
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PaySlipHalfPage = New PaySlipHalfPage()
        rpt.Site = Me.Site
        Return rpt
    End Function
