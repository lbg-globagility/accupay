...
Public Class prntAllPaySlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.prntAllPaySlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedprntAllPaySlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As prntAllPaySlip = New prntAllPaySlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
