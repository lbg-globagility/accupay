...
Public Class HyundaiPayslip1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.HyundaiPayslip1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHyundaiPayslip1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HyundaiPayslip1 = New HyundaiPayslip1()
        rpt.Site = Me.Site
        Return rpt
    End Function
