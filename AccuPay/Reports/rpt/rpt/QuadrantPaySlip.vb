...
Public Class QuadrantPaySlip
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.QuadrantPaySlip.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedQuadrantPaySlip
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As QuadrantPaySlip = New QuadrantPaySlip()
        rpt.Site = Me.Site
        Return rpt
    End Function
