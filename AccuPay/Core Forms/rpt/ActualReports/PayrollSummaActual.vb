...
Public Class PayrollSummaActual
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AccuPay.PayrollSummaActual.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollSummaActual
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollSummaActual = New PayrollSummaActual()
        rpt.Site = Me.Site
        Return rpt
    End Function
