...
Public Class DependencyInjectionHelper
    ...
    Private Shared Sub ConfigureServices(services As ServiceCollection)
        ...
        services.AddTransient(Of ISoloParentBeneficiaryRepository, SoloParentBeneficiaryRepository)
        ...
        services.AddTransient(Of ISoloParentBeneficiaryDataService, SoloParentBeneficiaryDataService)
