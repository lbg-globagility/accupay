...
DROP TABLE IF EXISTS `employeetimeentryallowancesalary`;
CREATE TABLE IF NOT EXISTS `employeetimeentryallowancesalary` (
  ...
  `SingleParentLeaveHours` decimal(11,6) NOT NULL DEFAULT 0.000000,
  PRIMARY KEY (`RowID`) USING BTREE,
  UNIQUE KEY `Unique_Key` (`OrganizationID`,`EmployeeID`,`Date`) USING BTREE
