namespace AccuPay.Web.Core.Auth
{
    public static class PermissionTypes
    {
        ...
        public const string DivisionDelete = "Division:delete";
        ...
        public const string PayPeriodUpdate = "PayPeriod:update";
        public const string PayPeriodDelete = "PayPeriod:delete";
