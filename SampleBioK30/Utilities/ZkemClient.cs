...
namespace SampleBioK30.Utilities
{
    public class ZkemClient : IZKEM
    {
        ...
        #region functions that will be used
        ...
        public int AccTimeZones { get ; set; }
        public int CardNumber { get ; set; }

        public int PINWidth => throw new NotImplementedException();

        public int MachineNumber { get ; set; }
        public string STR_CardNumber { get ; set ; }

        public int SSRPin => throw new NotImplementedException();
