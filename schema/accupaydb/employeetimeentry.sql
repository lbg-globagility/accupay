...
CREATE TABLE IF NOT EXISTS `employeetimeentry` (
  ...
  CONSTRAINT `FK_employeetimeentry_employeesalary_EmployeeSalaryID` FOREIGN KEY (`EmployeeSalaryID`) REFERENCES `employeesalary` (`RowID`) ON DELETE SET NULL,
  CONSTRAINT `FK_employeetimeentry_employeeshift_EmployeeShiftID` FOREIGN KEY (`EmployeeShiftID`) REFERENCES `employeeshift` (`RowID`) ON DELETE SET NULL,
