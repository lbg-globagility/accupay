...
CREATE TABLE IF NOT EXISTS `audittrail_copy` (
  ...
  CONSTRAINT `audittrail_copy_ibfk_1` FOREIGN KEY (`OrganizationID`) REFERENCES `organization` (`RowID`),
  CONSTRAINT `audittrail_copy_ibfk_2` FOREIGN KEY (`CreatedBy`) REFERENCES `user` (`RowID`),
  CONSTRAINT `audittrail_copy_ibfk_3` FOREIGN KEY (`LastUpdBy`) REFERENCES `user` (`RowID`)
