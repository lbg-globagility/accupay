...
CREATE TABLE IF NOT EXISTS `shift` (
  ...
  `ShiftHours` decimal(10,2) DEFAULT 0.00 COMMENT 'number of hours of shift less break',
  `WorkHours` decimal(10,2) DEFAULT 0.00,
  PRIMARY KEY (`RowID`),
  UNIQUE KEY `Index 5` (`TimeFrom`,`TimeTo`,`OrganizationID`,`BreakTimeFrom`,`BreakTimeTo`),
