...
CREATE TABLE IF NOT EXISTS `employeeleave` (
  ...
  `OfficialValidHours` decimal(15,4) DEFAULT NULL,
  `OfficialValidDays` decimal(15,4) DEFAULT NULL,
  PRIMARY KEY (`RowID`),
  ...
  CONSTRAINT `employeeleave_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`RowID`),
