...
CREATE TABLE IF NOT EXISTS `employeeovertime` (
  ...
  CONSTRAINT `employeeovertime_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`RowID`) ON DELETE CASCADE,
  CONSTRAINT `employeeovertime_ibfk_2` FOREIGN KEY (`OrganizationID`) REFERENCES `organization` (`RowID`),
  CONSTRAINT `employeeovertime_ibfk_3` FOREIGN KEY (`CreatedBy`) REFERENCES `user` (`RowID`) ON DELETE CASCADE,
  CONSTRAINT `employeeovertime_ibfk_4` FOREIGN KEY (`LastUpdBy`) REFERENCES `user` (`RowID`) ON DELETE CASCADE
