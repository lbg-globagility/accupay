...
CREATE TABLE IF NOT EXISTS `paystubbonus` (
  ...
  `RestDayOTHours` decimal(15,4) DEFAULT NULL,
  `RestDayOTPay` decimal(15,4) DEFAULT NULL,
  `LeaveHours` decimal(15,4) DEFAULT NULL,
  `LeavePay` decimal(15,4) DEFAULT NULL,
  `SpecialHolidayHours` decimal(15,4) DEFAULT NULL,
  `SpecialHolidayPay` decimal(15,4) DEFAULT NULL,
  `SpecialHolidayOTHours` decimal(11,6) NOT NULL DEFAULT 0.000000,
  `SpecialHolidayOTPay` decimal(11,6) NOT NULL DEFAULT 0.000000,
  `RegularHolidayHours` decimal(15,4) DEFAULT NULL,
  `RegularHolidayPay` decimal(15,4) DEFAULT NULL,
  ...
  `AbsentHours` decimal(15,4) DEFAULT NULL,
  ...
  CONSTRAINT `paystubbonus_ibfk_1` FOREIGN KEY (`EmployeeID`) REFERENCES `employee` (`RowID`) ON DELETE CASCADE,
