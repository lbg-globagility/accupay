...
CREATE TABLE IF NOT EXISTS `payrate` (
  ...
  `PayRate` decimal(10,4) DEFAULT NULL COMMENT 'payout rate 1.10, 1.20,2.0 (10%, 20%, 100%, etc)',
  `OvertimeRate` decimal(10,4) DEFAULT NULL,
  `NightDifferentialRate` decimal(10,4) DEFAULT NULL,
  `NightDifferentialOTRate` decimal(10,4) DEFAULT NULL,
  `RestDayRate` decimal(10,4) DEFAULT NULL,
  `RestDayOvertimeRate` decimal(10,4) DEFAULT NULL,
  `RestDayNDRate` decimal(10,4) DEFAULT 0.0000,
  `RestDayNDOTRate` decimal(10,4) DEFAULT 0.0000,
  PRIMARY KEY (`RowID`),
