        ...
        public class PaystubModel
        {
            ...
            public Dictionary<string, string> LookUp
            {
                get
                {
                    ...
                    _lookUp["EmployeeIdKey"] = this.EmployeeId.ToString();
                    _lookUp["EmployeeNameKey"] = this.EmployeeName;
                    _lookUp["TotalDaysKey"] = this.RegularDays.ToString();
                    _lookUp["TotalHoursKey"] = this.RegularHours.ToString();
                    _lookUp["DailyRateKey"] = this.DailyRate.ToString();
                    _lookUp["HoulyRateKey"] = this.HourlyRate.ToString();
                    _lookUp["BasicPayKey"] = this.RegularPay.ToString();
                    _lookUp["OvertimeHoursKey"] = this.OvertimeHours.ToString();
                    _lookUp["OvertimePayKey"] = this.OvertimePay.ToString();
                    _lookUp["NightDiffHoursKey"] = this.NightDiffHours.ToString();
                    _lookUp["NightDiffPayKey"] = this.NightDiffPay.ToString();
                    _lookUp["NightDiffOvertimeHoursKey"] = this.NightDiffOvertimeHours.ToString();
                    _lookUp["NightDiffOvertimePayKey"] = this.NightDiffOvertimePay.ToString();
                    _lookUp["SpecialHolidayHoursKey"] = this.SpecialHolidayHours.ToString();
                    _lookUp["SpecialHolidayPayKey"] = this.SpecialHolidayPay.ToString();
                    _lookUp["SpecialHolidayOTHoursKey"] = this.SpecialHolidayOTHours.ToString();
                    _lookUp["SpecialHolidayOTPayKey"] = this.SpecialHolidayOTPay.ToString();
                    _lookUp["RegularHolidayHoursKey"] = this.RegularHolidayHours.ToString();
                    _lookUp["RegularHolidayPayKey"] = this.RegularHolidayPay.ToString();
                    _lookUp["RegularHolidayOTHoursKey"] = this.RegularHolidayOTHours.ToString();
                    _lookUp["RegularHolidayOTPayKey"] = this.RegularHolidayOTPay.ToString();
                    _lookUp["GrossPayKey"] = this.GrossPay.ToString();
                    _lookUp["SSSAmountKey"] = this.SSSAmount.ToString();
                    _lookUp["ECAmountKey"] = this.ECAmount.ToString();
                    _lookUp["HDMFAmountKey"] = this.HDMFAmount.ToString();
                    _lookUp["PhilHealthAmountKey"] = this.PhilHealthAmount.ToString();
                    _lookUp["HMOAmountKey"] = this.HMOAmount.ToString();
                    _lookUp["ThirteenthMonthPayKey"] = this.ThirteenthMonthPay.ToString();
                    _lookUp["FiveDaySilpAmountKey"] = this.FiveDaySilpAmount.ToString();
                    _lookUp["NetPayKey"] = this.NetPay.ToString();
