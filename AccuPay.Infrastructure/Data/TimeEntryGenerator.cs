...
{
    public class TimeEntryGenerator : ITimeEntryGenerator
    {
        //private static ILog logger = LogManager.GetLogger("TimeEntryLogger", "TimeEntryLogger");

        private readonly PayrollContext _context;
        private readonly ITimeEntryDataService _timeEntryDataService;

        public TimeEntryGenerator(PayrollContext context, ITimeEntryDataService timeEntryDataService)
        {
            _context = context;
            ...
            TimePeriod payPeriod)
        {
            ...
            var salaries = resources.Salaries2.Where(s => s.EmployeeID == employee.RowID);
