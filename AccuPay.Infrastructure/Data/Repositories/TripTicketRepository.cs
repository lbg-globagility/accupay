...
{
    public class TripTicketRepository : ITripTicketRepository
    {
        ...
        public async Task SaveImportAsync(List<TripTicket> tripTickets, List<Route> routes, List<Vehicle> vehicles, int organizationId, int userId)
        {
