...
Public Class Employees_13th_Month_Pay_Report
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Employee's 13th Month Pay Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GoldWingsPayrollSys.Employee's 13th Month Pay Report.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEmployees_13th_Month_Pay_Report
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Employees_13th_Month_Pay_Report = New Employees_13th_Month_Pay_Report()
        rpt.Site = Me.Site
        Return rpt
    End Function
