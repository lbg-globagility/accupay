...
Public Class LeaveForm
    ...
    Function INSUPD_employeeleave() As Object
        ...
        param(1, 1) = EXECQUER("SELECT OrganizationID FROM employee WHERE RowID='" & TxtEmployeeNumber1.RowIDValue & "';")
        'previous_orgID
        ...
        param(3, 1) = LeaveTypeValue 'CObj(cboleavetypes.Text).ToString 'Leave type
        param(4, 1) = If(z_User = 0, DBNull.Value, z_User)
        param(5, 1) = param(4, 1) 'z_User
        param(6, 1) = TxtEmployeeNumber1.RowIDValue 'n_EmployeeRowID
        ...
        param(9, 1) = Format(CDate(dtpendate.Value), "yyyy-MM-dd") 'End date
    ...
    Private Sub TxtEmployeeNumber1_Leave(sender As Object, e As EventArgs) Handles TxtEmployeeNumber1.Leave
        ...
        If orgztnID = Nothing Then
            ...
            Dim org_rowid = _
                EXECQUER("SELECT OrganizationID FROM employee WHERE RowID='" & TxtEmployeeNumber1.RowIDValue & "';")
    ...
    Private Sub cboleavetypes_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboleavetypes.SelectedIndexChanged, cboleavetypes.SelectedValueChanged
        LeaveTypeValue = cboleavetypes.Text
    End Sub
    ...
    Private Sub bgwEmpNames_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles bgwEmpNames.DoWork
        ...
        dtempfullname = retAsDatTbl("SELECT CONCAT(e.LastName,', ',e.FirstName, IF(e.MiddleName = '', '', CONCAT(', ',e.MiddleName))) 'EmpFullName'" & _
                                    " FROM employee e INNER JOIN organization og ON og.RowID=e.OrganizationID" & _
                                    " WHERE og.NoPurpose='0'" & _
                                    " GROUP BY CONCAT(e.LastName,', ',e.FirstName, IF(e.MiddleName = '', '', CONCAT(', ',e.MiddleName)));")
