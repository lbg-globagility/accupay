...
Public Class PayrollSumaryRpt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "GoldWingsPayrollSys.PayrollSumaryRpt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayrollSumaryRpt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayrollSumaryRpt = New PayrollSumaryRpt()
        rpt.Site = Me.Site
        Return rpt
    End Function
